...
view: _all_logs {
  # because of the large amounts of auto generated lookml in this project, we are putting
  # the raw lookml associated with the clould logging schema in this file, which we will
  # then refine. In case of any future changes to the schema, we can simply replace this file
  # with new autogenerated lookml.
